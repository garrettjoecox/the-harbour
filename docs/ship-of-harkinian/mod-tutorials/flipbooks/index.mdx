...
| objects/object_link_child | gLinkAdultEyesOpenTex | Eyes open |
| objects/object_link_child | gLinkAdultEyesHalfTex | Eyes half-open (mid-blink) |
| objects/object_link_child | gLinkAdultEyesClosedfTex | Eyes closed |
| objects/object_link_child | gLinkAdultEyesRollRightTex | Eyes facing to the RIGHT of the image |
| objects/object_link_child | gLinkAdultEyesRollLeftTex | Eyes facing to the LEFT of the image |
| objects/object_link_child | gLinkAdultEyesUnk1Tex | Eyes looking down |
| objects/object_link_child | gLinkAdultEyesUnk2Tex | Eyes closed hard / wincing |
| objects/object_link_child | gLinkAdultEyesShockTex | Eyes wide open |
| objects/object_link_child | gLinkAdultMouth1Tex | Mouth closed |
| objects/object_link_child | gLinkAdultMouth2Tex | Mouth half-open |
| objects/object_link_child | gLinkAdultMouth3Tex | Mouth open |
| objects/object_link_child | gLinkAdultMouth4Tex | Mouth smiling |
